...
public class Soru3Ekstra {
	...
	public static void main(String[] args) {
		...
		//--> eğer toplam int ise sonucun float çıkması için 2'nin sonuna 'f' eklenmelidir(28.satır)
...
//		}
		...
		//Ancak bir değişkene atayarak daha sonra bu değeri sout' a vermek daha doğrudur.
